...
**Fecha:** 21-05-2026
**Norma aplicada:** ISO/IEC/IEEE 26514:2022
...
```
[ Navegador ] → puerto 8069 → [ Contenedor ERP ] → red interna → [ Contenedor PostgreSQL ]
```
...
`wkhtmltopdf` es una herramienta que "simula" un navegador web para convertir páginas HTML en documentos PDF, respetando todos los estilos CSS.
```